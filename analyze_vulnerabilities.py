...
# These tuples have to be a key for the vulnerabilities and a possible value
def filter_vulnerabilities(vul_dict, filter_tuples):
	new_vul_dict = dict()
	for vul_id, vul_details in vul_dict.items():
		if not is_filtered(vul_details[0], filter_tuples):
			new_vul_dict[vul_id] = vul_details
	return new_vul_dict
